...
describe("Lógica de Cálculo de Precios", () => {
  ...
  // Test para verificar que los menores de 3 años no pagan.
  ...
  // Test para verificar el descuento del 50% para niños (hasta 10 años).
  ...
  // Test para verificar el descuento del 50% para mayores (desde 60 años).
  ...
  // Test para verificar el precio completo para un adulto.
  ...
  it("debería calcular correctamente el total para un grupo mixto", () => {
    ...
    // Total esperado: 5000 + 5000 + 2500 + 0 = 12500
    const resultado = calcularPrecioTotal(entradas);
